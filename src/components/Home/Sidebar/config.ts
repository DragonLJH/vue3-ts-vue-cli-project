    ...
    title: "User Controller", label: "用户管理", icon: "", type: "user", children: [
      {
        ...
        newlyAdded: JSON.stringify({ title: "insertUser", label: "注册用户", url: "/user/insertUser" }),
        strikeOut: JSON.stringify({ title: "deleteUserById", label: "根据id删除用户信息", url: "/user/deleteUserById" })
      },
    ]
  },
  {
    title: "Emerge Controller", label: "分类管理", icon: "", type: "emerge", children: [
      {
        ...
        newlyAdded: JSON.stringify({ title: "insertEmerge", label: "新增分类信息", url: "/emerge/insertEmerge" }),
        strikeOut: JSON.stringify({ title: "deleteEmergeById", label: "根据id删除分类信息", url: "/emerge/deleteEmergeById" })
    ...
    title: "Product Controller", label: "商品管理", icon: "", type: "product", children: [
      {
        ...
        newlyAdded: JSON.stringify({ title: "insertProduct", label: "新增商品", path: "/uploadPage", url: "/product/insertProduct" }),
        strikeOut: JSON.stringify({ title: "deleteProductById", label: "根据id删除商品", url: "/product/deleteProductById" })
      },
    ...
    title: "Type Controller", label: "类型管理", icon: "", type: "type", children: [
      {
        ...
        newlyAdded: JSON.stringify({ title: "insertType", label: "新增类型", url: "/type/insertType" }),
        strikeOut: JSON.stringify({ title: "deletdTypeById", label: "根据id删除类型", url: "/type/deletdTypeById" })
      },
    ]
  },
  {
    title: "Order Controller", label: "订单管理", icon: "", type: "order", children: [
      {
        ...
        newlyAdded: JSON.stringify({ title: "insertOrder", label: "新增订单", url: "/order/insertOrder" }),
        strikeOut: JSON.stringify({ title: "deletdOrderById", label: "根据id删除订单", url: "/type/deletdOrderById" })
      },
    ]
  },
  {
    title: "Comment Controller", label: "评论管理", icon: "", type: "comment", children: [
      {
        ...
        newlyAdded: JSON.stringify({ title: "insertComment", label: "新增产品评论信息", url: "/comment/insertComment" }),
        strikeOut: JSON.stringify({ title: "deleteComment", label: "根据id删除产品评论信息", url: "/comment/deleteComment" })
      },
    ]
  },
  {
    title: "Shop Controller", label: "购物车管理", icon: "", type: "shop", children: [
      ...
      { title: "queryShopByUserName", label: "根据用户名获取购物车的商品", path: "/queryPage", url: "/shop/queryShopByUserName" },
      {
        ...
        newlyAdded: JSON.stringify({ title: "insertShop", label: "添加购物信息", url: "/shop/insertShop" }),
        strikeOut: JSON.stringify({ title: "deleteShopbyId", label: "根据id删除购物信息", url: "/shop/deleteShopbyId" })
      },
    ]
  },
  {
    title: "Rotation Controller", label: "轮播管理", icon: "", type: "rotation", children: [
      ...
      { title: "uploadRotationImg", label: "上传轮播图片", path: "/uploadPage", url: "/rotation/uploadRotationImg" },
      {
        ...
        newlyAdded: JSON.stringify({ title: "insertRotation", label: "新增轮播信息", url: "/rotation/insertRotation" }),
        strikeOut: JSON.stringify({ title: "deleteRotationById", label: "根据id删除轮播信息", url: "/rotation/deleteRotationById" })
      },
    ]
  },
]
